                        ...
                        <div class="d-flex flex-column h-100">
                            <div class="mb-4 mb-md-5 text-center">
                                <a href="{{ url('/') }}" class="d-block auth-logo">
                                    <img src="{{ URL::asset('images/logos.jpg') }}" alt="" height="30" style="transform:rotate(90deg); height:150px; width:80px;"> <span class="logo-txt"></span>
                                </a>
                            </div>
                            <div class="auth-content my-auto">
                                ...
                                <form class="mt-4 pt-2" action="{{ route('login') }}" method="POST">
                                    ...
                                    <div class="form-floating form-floating-custom mb-4">
                                        <input type="text" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', 'admin@logos.com') }}" id="input-username" placeholder="Enter User Name" name="email">
                                        @error('email')
