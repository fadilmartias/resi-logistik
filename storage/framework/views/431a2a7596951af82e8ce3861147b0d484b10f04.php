    ...
    <div class="container-fluid bg-white vh-100">
        <div class="row">
            <div class="col m-3" id="data_brg">
                <table class="border-0">
                    <tbody>
                    <tr><td>Nomor</td><td>&emsp;&emsp;:&nbsp;</td><td><?php echo e($resi->nomor); ?></td></tr>
                    <tr><td>Tanggal/Datum/Date</td><td>&emsp;&emsp;:&nbsp;</td><td><?php echo e($resi->tanggal); ?></td></tr>
                    <tr><td>Berat/Gewicht/Weight</td><td>&emsp;&emsp;:&nbsp;</td><td><?php echo e($resi->berat); ?></td></tr>
                    <tr><td>Ukuran/Dimension/MaB</td><td>&emsp;&emsp;:&nbsp;</td><td><?php echo e($resi->ukuran); ?></td></tr>
                    <tr><td>Isi/Contents/Inhalt</td><td>&emsp;&emsp;:&nbsp;</td><td><?php echo e($resi->isi); ?></td></tr>
                    <tr><td>Layanan/Service</td><td>&emsp;&emsp;:&nbsp;</td><td><?php echo e($resi->layanan); ?></td></tr>
                    </tbody>
                </table>
            </div>
        </div>
        <div class="row mt-3 m-2">
            <div class="col-md-5">
                ...
                <div class="border-bottom border-dark mb-5"></div>
                <div class="border-bottom border-dark mb-5"></div>
                <div class="text-center" style="font-size: 20px;"><?php echo e($resi->pengirim); ?></div>
            </div>
            <div class="col-md-2 text-center">
                <img src="<?php echo e(asset('images/logos.jpg')); ?>" id="logo" alt="">
            </div>
            <div class="col-md-5">
                ...
                <div class="border-bottom border-dark mb-5"></div>
                <div class="border-bottom border-dark mb-5"></div>
                <div class="text-center" style="font-size: 20px;"><?php echo e($resi->penerima); ?></div>
            </div>
        </div>
    </div>
